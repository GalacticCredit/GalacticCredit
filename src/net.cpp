...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "GalacticCredit " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"galacticcredittools.com", "192.168.2.190"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"galacticcredittools.com", "testnet-seed.galacticcredittools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. GalacticCredit is probably already running."), addrBind.ToString().c_str());
        else
